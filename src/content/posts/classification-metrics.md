...
<figure class="lesson-video">
  <video controls playsinline preload="metadata" poster="/images/covers/classification-metrics-video.jpg" aria-label="第 7 课：准确率、精确率、召回率和 F1 怎么看">
    <source src="/videos/lesson-07-classification-metrics.mp4" type="video/mp4" />
    你的浏览器暂不支持视频播放，可以继续阅读下方文字版课程。
  </video>
  <figcaption>第 7 课视频 · 准确率、精确率、召回率和 F1（约 1 分 14 秒）</figcaption>
</figure>
