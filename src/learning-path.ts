...
export const contentSections: ContentSection[] = [
  ...
  },
  {
    ...
    postIds: [
      ...
      'build-binary-classification-nn',
      'decision-boundary-visualization',
      'tabular-classification-nn',
      'model-save-load-batch-inference',
      'cnn-convolution-pooling',
      'image-data-channels-size-batch',
      'first-cnn-image-classification',
      'image-classification-error-analysis',
